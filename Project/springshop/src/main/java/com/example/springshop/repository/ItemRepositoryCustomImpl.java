...
import com.example.springshop.dto.QMainItemDto;
import com.example.springshop.entity.Item;
import com.example.springshop.entity.QItem;
import com.example.springshop.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    public Page<Item> getAdminItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        QueryResults<Item> results = queryFactory.selectFrom(QItem.item)
                .where(regDtsAfter(itemSearchDto.getSearchDateType()), searchSellStatusEq(itemSearchDto.getItemSellStatus()),
